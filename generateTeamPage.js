...
const teamPath = path.join(__dirname, 'frontend', 'app', '(marketing)', 'team', 'page.tsx');
...
const getRole = (name: string) => {
  if (name.toLowerCase().includes("khushi")) return "Founder & CEO";
  if (name.toLowerCase().includes("shadan")) return "Chief Technology Officer";
  if (name.toLowerCase().includes("shivam")) return "Lead Product Designer";
