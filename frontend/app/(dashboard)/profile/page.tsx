        ...
        <div className="flex items-center gap-6 min-w-0">
          ...
          <div className="relative shrink-0">
            {user?.avatarUrl ? (
              ...
              <div className={cn("w-20 h-20 rounded-full bg-gradient-to-br from-brand-orange to-brand-orange/60 flex items-center justify-center font-bold text-[28px] text-white shadow-lg shadow-brand-orange/10 shrink-0 font-sans transition-all duration-300", user?.isPremiumActive ? "ring-4 ring-brand-orange ring-offset-4 dark:ring-offset-[#0c0d16]" : "border border-white/[0.08]")}>
