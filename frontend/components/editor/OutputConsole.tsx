...
interface OutputConsoleProps {
  ...
  testResultState: "none" | "running" | "accepted";
}
        ...
        <div className="flex-1 min-h-0 pt-3 relative overflow-hidden">
          {testResultState === "running" ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full overflow-y-auto custom-scrollbar pr-1">
                ...
                <div className="flex flex-col gap-2 border-l border-border-card/60 pl-0 md:pl-4 text-left text-[12px]">
                  ...
                  <div className="flex items-baseline gap-2 select-none">
                    <span className="text-[13px] font-bold text-[#10b981]">Accepted</span>
                    <span className="text-[11px] text-text-secondary font-bold font-mono">Runtime: 32 ms</span>
                  </div>

                  {/* Casepassed tick */}
                  <div className="flex items-center gap-1.5 text-[#10b981] font-bold text-[11.5px] select-none">
                    <Check className="w-3.5 h-3.5 stroke-[3.5]" />
                    <span>Case {selectedTestCase} passed</span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-1">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="p-1.5 bg-gray-100 dark:bg-white/[0.03] border border-border-card rounded-lg font-mono text-[#10b981] font-bold select-text text-center">
            ...
            <div className="w-full h-full bg-gray-100 dark:bg-white/[0.02] border border-border-card rounded-xl p-3.5 font-mono text-[11.5px] leading-relaxed text-text-secondary select-text overflow-y-auto custom-scrollbar text-left shadow-inner">
              ...
              <div className="text-[#10b981] mt-0.5">&gt; TestCase 1: Passed (Runtime: 32ms, Memory: 42MB)</div>
              <div className="text-[#10b981]">&gt; TestCase 2: Passed (Runtime: 28ms, Memory: 42MB)</div>
              <div className="text-[#10b981]">&gt; TestCase 3: Passed (Runtime: 35ms, Memory: 42MB)</div>
