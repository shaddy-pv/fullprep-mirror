export const DESIGN_SYSTEM = {
  ...
  glows: {
    orange: "shadow-[0_0_15px_rgba(255,106,0,0.12)]",
    orangeHover: "shadow-[0_0_20px_rgba(255,106,0,0.55),_0_6px_16px_rgba(255,106,0,0.35)]",
...
export const DESIGN_SYSTEM_TOKENS = {
  ...
  forms: {
    ...
    toggleActive: "bg-brand-orange shadow-[0_0_6px_rgba(255,106,0,0.2)]",
  },

  // Action Buttons
  buttons: {
    primary: "flex items-center justify-center bg-brand-orange hover:bg-[#e05d00] text-white rounded-xl px-5 py-2.5 text-sm font-bold shadow-md shadow-brand-orange/15 hover:shadow-[0_0_12px_rgba(255,106,0,0.3)] cursor-pointer transition-all duration-200 leading-none h-[38px] hover:scale-[1.01]",
