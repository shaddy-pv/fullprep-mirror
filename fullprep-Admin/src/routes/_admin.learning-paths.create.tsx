...
export const Route = createFileRoute("/_admin/learning-paths/create")({
  head: () => ({ meta: [{ title: "Create Learning Path — FullPrep Admin" }] }),
...
function CreateLearningPathPage() {
  ...
  const [form, setForm] = useState({
    ...
    content: "",
    modules: [{ title: "Module 1", description: "", problems: [] as string[] }],
  });
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-text-primary">Create Learning Path</h1>
          <p className="text-sm text-text-muted">Build a new premium or free course.</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <label className="block">
              ...
              <input
                ...
                className={inputCls}
                placeholder="e.g. top-100-system-design"
              />
            </label>
            <label className="block">
              <span className="mb-1.5 block text-xs font-semibold text-text-secondary uppercase">
