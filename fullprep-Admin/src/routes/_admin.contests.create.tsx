...
function CreateContestPage() {
  ...
  const [form, setForm] = useState({
    ...
    startTime: "",
    endTime: "",
    problems: [] as string[], // array of Problem ObjectIds
    isActive: true,
  });
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      alert("Failed to create contest. See console.");
    } finally {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 pb-12">
      ...
      <div>
        ...
        <p className="text-sm text-text-muted">Schedule a new custom contest</p>
      </div>
        ...
        <div className="rounded-2xl border border-border-card bg-surface p-6 shadow-sm space-y-5">
          ...
          <label className="block">
            ...
            <input
              ...
              placeholder="e.g. Weekly Challenge 55"
            />
          </label>
